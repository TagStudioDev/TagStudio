...
def test_update_selection_empty(qt_driver, library):
    ...
    assert not panel.add_tag_button_enabled()
    assert not panel.add_field_button_enabled()
...
def test_update_selection_single(qt_driver, library, entry_full):
    ...
    assert panel.add_tag_button_enabled()
    assert panel.add_field_button_enabled()
