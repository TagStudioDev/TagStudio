...
class Library:
    ...
    def open_sqlite_library(
        ...
        migrations = [
            ...
            (self.__apply_db301_migration, 301, None),  # changes: add category_exclusions
        ]
    ...
    def __apply_db301_migration(self, session: Session, library_dir: Path):
        ...
        The category_exclusion table is generated by SQLAlchemy.
        This only exists set the correct DB_VERSION.
        """
        pass
