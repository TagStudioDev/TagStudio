...
from PySide6.QtWidgets import (QAbstractScrollArea, QCheckBox, QDialogButtonBox, QFrame, QGridLayout,
...
class Ui_Settings(QDialog):
    ...
    def setupUi(self, Settings):
        ...
        sizePolicy2.setHeightForWidth(self.autosave_interval.sizePolicy().hasHeightForWidth())
        ...
        self.autosave_toggle.setObjectName(u"autosave_toggle")
        sizePolicy2.setHeightForWidth(self.autosave_toggle.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy2.setHeightForWidth(self.scrollAreaWidgetContents_4.sizePolicy().hasHeightForWidth())
        ...
        self.general_tab_3.setObjectName(u"general_tab_3")
        ...
        self.render_thumbnails.setObjectName(u"render_thumbnails")
        sizePolicy2.setHeightForWidth(self.render_thumbnails.sizePolicy().hasHeightForWidth())
        self.render_thumbnails.setSizePolicy(sizePolicy2)
        self.render_thumbnails.setChecked(False)

        self.general_tab_3.addWidget(self.render_thumbnails, 1, 0, 1, 2)

        self.horizontalSpacer_3 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.general_tab_3.addItem(self.horizontalSpacer_3, 0, 2, 1, 1)

        self.verticalSpacer_3 = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.general_tab_3.addItem(self.verticalSpacer_3, 2, 0, 1, 1)
    ...
    def retranslateUi(self, Settings):
        ...
        self.label.setText(QCoreApplication.translate("Settings", u"Saving/Loading", None))
        self.autosave_interval.setSuffix(QCoreApplication.translate("Settings", u" minutes", None))
        self.label_2.setText(QCoreApplication.translate("Settings", u"Autosave Interval", None))
        self.autosave_toggle.setText(QCoreApplication.translate("Settings", u"Autosave", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("Settings", u"General", None))
        self.render_thumbnails.setText(QCoreApplication.translate("Settings", u"Do not render thumbnails.", None))
        self.label_5.setText(QCoreApplication.translate("Settings", u"Mainview", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QCoreApplication.translate("Settings", u"Performance", None))
    # retranslateUi
    ...
    def getSettings(self):
        ...
        # General settings
        settings['autosave'] = self.autosave_toggle.isChecked()
        settings['autosave_interval'] = self.autosave_interval.value()

        # Performance settings
        settings['render_thumbnails'] = not self.render_thumbnails.isChecked()
        return settings

    def setSettings(self, settings:QSettings):
        if settings.contains('autosave'):
            self.autosave_toggle.setChecked(bool(settings.value('autosave')))

        if settings.contains('autosave_interval'):
            self.autosave_interval.setValue(int(settings.value('autosave_interval')))
        
        if settings.contains('render_thumbnails'):
            self.render_thumbnails.setChecked(bool(settings.value('render_thumbnails')))
    # retranslateUi
