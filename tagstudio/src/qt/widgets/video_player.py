...
from PySide6.QtCore import Qt, QSize, QTimer, QVariantAnimation, QUrl, QObject, QEvent, QRect, QRectF
from PySide6.QtMultimedia import QMediaPlayer, QAudioOutput, QMediaDevices, QAudioFormat, QAudioDecoder, QAudioBuffer
from PySide6.QtMultimediaWidgets import QGraphicsVideoItem
from PySide6.QtWidgets import QGraphicsView, QGraphicsScene, QGraphicsPixmapItem, QSizePolicy, QLabel, QGraphicsEffect, QStyleOption, QWidget, QGraphicsItem
from PySide6.QtGui import QDragMoveEvent, QInputMethodEvent, QPainter, QPen, QColor, QBrush, QResizeEvent, QWheelEvent, QAction, QPixmap, QRegion, QBitmap
...
class VideoPlayer(QGraphicsView):
	...
	def __init__(self) -> None:
		...
		self.album_art.setPixmap(QPixmap('./tagstudio/resources/qt/images/thumb_file_default_512.png'))
	...
	def roundCorners(self) -> None:
		mask = Image.new('RGBA', (int(self.video_preview.size().width()), int(self.video_preview.size().height())), (0, 0, 0, 255))
